...
class MainView:
    ...
    def _initialize(self):
        ...
        label = ttk.Label(master=self._frame, text="Virtuaalipäiväkirja",font=('Helvetica', 18, 'bold'), background="lightblue")
        sub_label = ttk.Label(master=self._frame, text="Tervetuloa sovellukseen! Käytä painikkeita kirjautuaksesi tai rekisteröityäksesi, jotta pääset käsiksi päiväkirjaan",font=('Helvetica', 13),background="lightblue")
