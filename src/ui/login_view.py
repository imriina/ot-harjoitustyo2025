...
class LoginView:
    ...
    def _initialize(self):
        ...
        label = ttk.Label(master=self._frame, text="Login Page",font=("Helvetica", 18, "bold"),background="lightblue")
        ...
        ttk.Label(master=self._frame, text="Käyttis:",background="lightblue").grid(row=1, column=0, pady=10, sticky="w", padx=10)
